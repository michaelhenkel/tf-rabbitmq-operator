...
import (
	...
	rabbitmqv1alpha1 "github.com/michaelhenkel/tf-rabbitmq-operator/pkg/apis/rabbitmq/v1alpha1"
...
func (r *ReconcileRabbitmq) deploymentForRabbitmq(m *rabbitmqv1alpha1.Rabbitmq) *appsv1.Deployment {
	...
	rabbitmqImage := fmt.Sprintf("%s/contrail-external-rabbitmq:%s", m.Spec.Registry, m.Spec.Version)
